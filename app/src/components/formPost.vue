<template>
    <div class="form form-post">
        ...
        <div class="form__item">
            ...
            <span class="form__error" v-show="errorTitle.flag">{{errorTitle.text}}</span>
        </div>
        <div class="form__item">
            ...
            <span class="form__error" v-show="errorShortDescr.flag">{{errorShortDescr.text}}</span>
        </div>
        <div class="form__item">
            ...
            <span class="form__error" v-show="errorDescr.flag">{{errorDescr.text}}</span>
        </div>
    ...
    export default {
        ...
        computed:{
            ...
            validation(){
                ...
                let flag = true;
                if (!this.post.title) {
                    this.errorTitle.flag = true;
                    flag = false;
                }
                if (!this.post.shortDescription) {
                    this.errorShortDescr.flag = true;
                    flag = false;
                }
                if (!this.post.description) {
                    this.errorDescr.flag = true;
                    flag = false;
                }
                setTimeout(function () {
                    that.errorTitle.flag = false;
                    that.errorShortDescr.flag = false;
                    that.errorDescr.flag = false;
                }, 1500);
